...
* The following workspace dependencies were updated
  * dependencies
    * @twin.org/cli-core bumped from ^0.0.1 to ^1.0.0
    * @twin.org/core bumped from ^0.0.1 to ^1.0.0
    * @twin.org/crypto bumped from ^0.0.1 to ^1.0.0
    * @twin.org/nameof bumped from ^0.0.1 to ^1.0.0
  * devDependencies
    * @twin.org/merge-locales bumped from ^0.0.1 to ^1.0.0
    * @twin.org/nameof-transformer bumped from ^0.0.1 to ^1.0.0
    * @twin.org/nameof-vitest-plugin bumped from ^0.0.1 to ^1.0.0
