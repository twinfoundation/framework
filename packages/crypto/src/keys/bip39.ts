...
export class Bip39 {
	 ...
	 */
	public static setWordList(wordlistData: string[], joiningChar: string = " "): void {
	...
	public static mnemonicToEntropy(mnemonic: string): Uint8Array {
		...
		if (newChecksum !== checksumBits) {
			throw new GeneralError(Bip39._CLASS_NAME, "checksumMismatch", { newChecksum, checksumBits });
		}
