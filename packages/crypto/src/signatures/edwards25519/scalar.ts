...
export function scalarMulAdd(s: Uint8Array, a: Uint8Array, b: Uint8Array, c: Uint8Array): void {
	...
	carry[0] = (s0 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s1 += carry[0];
	s0 -= carry[0] << BIG_ARR[21];
	carry[2] = (s2 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s3 += carry[2];
	s2 -= carry[2] << BIG_ARR[21];
	carry[4] = (s4 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s5 += carry[4];
	s4 -= carry[4] << BIG_ARR[21];
	carry[6] = (s6 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s7 += carry[6];
	s6 -= carry[6] << BIG_ARR[21];
	carry[8] = (s8 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s9 += carry[8];
	s8 -= carry[8] << BIG_ARR[21];
	carry[10] = (s10 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s11 += carry[10];
	s10 -= carry[10] << BIG_ARR[21];
	carry[12] = (s12 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s13 += carry[12];
	s12 -= carry[12] << BIG_ARR[21];
	carry[14] = (s14 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s15 += carry[14];
	s14 -= carry[14] << BIG_ARR[21];
	carry[16] = (s16 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s17 += carry[16];
	s16 -= carry[16] << BIG_ARR[21];
	carry[18] = (s18 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s19 += carry[18];
	s18 -= carry[18] << BIG_ARR[21];
	carry[20] = (s20 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s21 += carry[20];
	s20 -= carry[20] << BIG_ARR[21];
	carry[22] = (s22 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s23 += carry[22];
	s22 -= carry[22] << BIG_ARR[21];

	carry[1] = (s1 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s2 += carry[1];
	s1 -= carry[1] << BIG_ARR[21];
	carry[3] = (s3 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s4 += carry[3];
	s3 -= carry[3] << BIG_ARR[21];
	carry[5] = (s5 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s6 += carry[5];
	s5 -= carry[5] << BIG_ARR[21];
	carry[7] = (s7 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s8 += carry[7];
	s7 -= carry[7] << BIG_ARR[21];
	carry[9] = (s9 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s10 += carry[9];
	s9 -= carry[9] << BIG_ARR[21];
	carry[11] = (s11 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s12 += carry[11];
	s11 -= carry[11] << BIG_ARR[21];
	carry[13] = (s13 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s14 += carry[13];
	s13 -= carry[13] << BIG_ARR[21];
	carry[15] = (s15 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s16 += carry[15];
	s15 -= carry[15] << BIG_ARR[21];
	carry[17] = (s17 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s18 += carry[17];
	s17 -= carry[17] << BIG_ARR[21];
	carry[19] = (s19 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s20 += carry[19];
	s19 -= carry[19] << BIG_ARR[21];
	carry[21] = (s21 + BIG_1_SHIFT_LEFT_20) >> BIG_ARR[21];
	s22 += carry[21];
