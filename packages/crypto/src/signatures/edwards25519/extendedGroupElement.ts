 ...
 */
import { ArrayHelper } from "@gtsc/core";
...
export class ExtendedGroupElement {
	...
	/**
	 * GeScalarMultiplyBase computes h = a*B, where
	 ...
	 * @param a The a.
	 */
	public scalarMultiplyBase(a: Uint8Array): void {
	...
	public cofactorEqual(q: ExtendedGroupElement): boolean {
		...
		return ArrayHelper.matches(zero, xBytes) && ArrayHelper.matches(yBytes, zBytes);
	}
}
