...
// @internal
export const BIG_1_SHIFT_LEFT_20: bigint = BigInt(1) << 20n;
// @internal
export const BIG_1_SHIFT_LEFT_24: bigint = BigInt(1) << 24n;
// @internal
export const BIG_1_SHIFT_LEFT_25: bigint = BigInt(1) << 25n;
