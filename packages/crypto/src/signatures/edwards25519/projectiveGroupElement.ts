...
export class ProjectiveGroupElement {
	 ...
	 */
	public double(r: CompletedGroupElement): void {
	 ...
	 */
	public toExtended(r: ExtendedGroupElement): void {
	 ...
	 * @param b The b.
	 */
	public doubleScalarMultiplyVarTime(a: Uint8Array, A: ExtendedGroupElement, b: Uint8Array): void {
	 ...
	 * @param a The a.
	 */
	private slide(r: Int8Array, a: Uint8Array): void {
		let i;
